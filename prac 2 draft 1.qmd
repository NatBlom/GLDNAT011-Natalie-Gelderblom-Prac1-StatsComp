...
av_ar_delay <- mulit.carriers |> group_by(origin,dest,carrier) |> summarise("average arrival delay"=mean(arr_delay, na.rm=TRUE)) 
av_ar_delay
...
flights |> semi_join(multiple.carriers, join_by(faa == origin))
